...
c-----------------------------------------------------------------------
  ...
  160 FORMAT(' Incremental Statement Labels (RELABEL 2019-1)'/
     1 1X,79('-'))
      END
      SUBROUTINE READIN
C=======================================================================
...
C-----LOAD NEW STATEMENT LABELS (LOAD BLANKS FOR UNREFERENCED LABELS).
   20 IF(NTAB.LE.0) GO TO 80
      ...
      DO 30 K=1,5
   30 NEWTAB(K,JJ)=BLANK
      GO TO 70
   40 J=J+1
      DO 50 K=1,4
   50 NEWTAB(K,JJ)=BLANK
      NEWTAB(5,JJ)='0'
      J2=J
      K=4
   60 I1=J2/10
...
C=======================================================================
     ...
     8 'c','l','o','s','e','('/
      DO 10 K=1,2
      DO 10 I=1,8
   10 ENDITX(I,K)=ENDX(I,K)
      DO 20 K=1,2
      DO 20 I=1,6
   20 FMTIT(I,K)=FMTX(I,K)
      BLANK=BLANKX
      PARENL=PARLX
      PARENR=PARRX
      COMMA=COMMAX
